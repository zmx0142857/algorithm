...
class Quad(object):
    ...
    >>> sqrt(2)/2
    1/2√2
    >>> f = lambda n: (2+sqrt(2))*(3+2*sqrt(2))**n # x**2 - 2 y**2 = 2 的正整数解
    >>> [f(n) for n in range(10)]
    [2+√2, 10+7√2, 58+41√2, 338+239√2, 1970+1393√2, 11482+8119√2, 66922+47321√2, 390050+275807√2, 2273378+1607521√2, 13250218+9369319√2]
    """
